\documentclass[12pt,authoryear]{LaTeXConfig/elsarticle} % Use elsarticle class
...
\title{Generator sets for Minkowski Sums - Theory and Insights\\
%\vspace*{1.5ex}
\texorpdfstring{
\vspace*{1.5ex}
\small
...
\tableofcontents  % just for having a temparary look
