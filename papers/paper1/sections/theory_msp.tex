...
\centering
	\begin{subfigure}{0.47\textwidth}
		\centering
		\scalebox{1}{\input{figures/ub_types_consecutive.pgf}}
		\caption{Consecutive}
	...
	\begin{subfigure}{0.47\textwidth}
		\centering
		\scalebox{1}{\input{figures/ub_types_supported.pgf}}
		\caption{Supported}
	...
	\begin{subfigure}{0.47\textwidth}
		\centering
		\scalebox{1}{\input{figures/ub_types_nonconsecutive.pgf}}
	...
	\begin{subfigure}{0.47\textwidth}
		\centering
		\scalebox{1}{\input{figures/ub_types_mixed.pgf}}
		\caption{mixed}
