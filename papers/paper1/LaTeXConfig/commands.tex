...
\newcommand{\Ysn}{\mathcal{Y}_{\mathcal{SN}}} % Supported Non-dominated points
\newcommand{\Yen}{\mathcal{Y}_{\mathcal{EN}}} % Supported Non-dominated points
...
\newcommand{\hY}{\hat{\mathcal{Y}}} % subset of non-dominated points
...
\newcommand{\abs}[1]{ \left\lvert#1\right\rvert}  % Cardinality of set or absolute value
